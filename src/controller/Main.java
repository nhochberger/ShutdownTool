...
public class Main {
	...
	public static void main(final String[] args) {
		...
		ConfiguredShutdownControllerFactory shutdownControllerFactory = new ConfiguredShutdownControllerFactory(properties);
		registerEventReceivers(gui, taskManager, shutdownControllerFactory.shutDownController());
		gui.show();
	}
